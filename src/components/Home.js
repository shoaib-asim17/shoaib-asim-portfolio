...
const Home = () => {
  ...
  return (
    <div
      className={`home my-12 min-h-screen p-5 rounded-lg relative transition duration-300 ease-in-out ${
        isDark
          ? "bg-gray-900 text-white shadow-lg backdrop-blur-sm"
          : "text-gray-800 shadow-md  bg-gray-50"
      }`}
      style={{ boxShadow: "0 4px 15px rgba(255, 255, 255, 0.5)" }}
    >
      {/* Bubble Effect */}
      <div className="bubble-container absolute inset-0 overflow-hidden"></div>

      <div className="container mx-auto mt-8 md:mt-24">
        <div className="text-center flex flex-col md:flex-row items-center justify-between mx-5 relative">
          {/* Text Content */}
